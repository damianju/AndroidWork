    ...
    class MyThread extends Thread{
        ...
        public void run() {
            ...
            while (mp.isPlaying()){ // 현재 재생 중이라면
                ...
                if(!isTracking) sb.setProgress(pos); // SeekBar 이동--> onProgressChanged() 호출함
            }
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //MediaPlay 객체 초기화, 재생
                mp  = MediaPlayer.create(getApplicationContext(),R.raw.chacha);// 현재화면의 제어권자, 음악 파일 리소스
        ...
        btnPause.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                pos = mp.getCurrentPosition(); // 현재 재쟁중이던 위치 저장.
                mp.pause(); // 일시 중지
