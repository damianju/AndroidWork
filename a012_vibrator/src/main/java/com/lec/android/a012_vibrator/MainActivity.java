    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnVib1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                vibrator.vibrate(5000); // 지정 시간 동안 진동
            }
        });
        ...
        btnVib2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                long[] pattern = {100, 300, 100, 700, 300, 2000}; //ms : 대기, 진동, 대기, 진동 ... 짝수 인덱스: 대기, 홀수 인덱스: 진동
                vibrator.vibrate(pattern, -1); // 진동패턴(배열), 반복여부(0: 무한 반복, -1: 반복 없음, 양의 정수: 진동패턴배열의 해당 인덱스부터 진동 무한 반복
            }
        });
