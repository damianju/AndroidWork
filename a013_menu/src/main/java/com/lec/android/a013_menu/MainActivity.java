...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        // 메뉴가 보여질 때마다 로그인/ 로그아웃이 enable/ disable 토글되어 보이기
        ...
        return super.onPrepareOptionsMenu(menu);  // false 리턴되면 메뉴 보여지지 않음.
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        // #2 특정 메뉴 아이템에 대한 동작, 각 색상이 눌렸을 때
    ...
    public void showInfo(MenuItem item){
        ...
        int groupId = item.getGroupId(); // 옵션 메뉴 아이템의 그룹 id값 (정수)
