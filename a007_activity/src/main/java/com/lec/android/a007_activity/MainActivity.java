...
public class MainActivity extends AppCompatActivity {
    ...
    // 다른 액티비티가 보여질 때 (혹은 다른 액티비티에 의해 가려지기 시작할 때) 호출
    ...
    // 액티비티가 더 이상 안 보여질 때 호출되는 메소드
    // 메모리 상황에 따라 호출 안 될 수도 있음.
    @Override
    ...
    // 액티비티 소멸될 때 호출
    // 액티비티 소멸은 시스템에 의해서 소멸되기도 하고 코드를 통해 제거되기도 함 : ex) finish()
    @Override
    ...
    // onRestoreInstanceState() 는 onStart 직후에 호촐됨.
    @Override
