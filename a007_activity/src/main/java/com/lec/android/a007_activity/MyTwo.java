...
public class MyTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // 넘겨받은 Intent 객체를 받는다
        ...
        int a = intent.getIntExtra("num", 0); // "num"이라는 name으로 넘어온 값을 받음. 만약 "num"이라는 name이 인텐트에 없었으면 디폴트값(두번째 매개변수)를 리턴
        int b = intent.getIntExtra("num2", 0);
        int c = intent.getIntExtra("num3", 999); //"num3"라는 이름은 없었다. //999 디폴트값 출력
