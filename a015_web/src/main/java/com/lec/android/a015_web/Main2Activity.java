    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnWebView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                wv.loadUrl(url); //웹페이지 url로 읽어오기
                wv.setWebChromeClient(new WebChromeClient()); // 안하면 alert() 같은 아림창 안 뜸.
                wv.setWebViewClient(new WebViewClient()); // 안하면 html 내부에서 다른 페이지로 이동 할 수가 없다.
